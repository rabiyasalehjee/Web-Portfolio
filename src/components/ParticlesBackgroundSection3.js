// ParticlesBackgroundSection3.js
...
const ParticlesBackgroundSection2 = () => {
  const particlesInit = useCallback(async (engine) => {
    console.log("Initializing particles for Section 3...");
    await loadFull(engine);
    console.log("Particles initialized for Section 3!");
  }, []);
...
export default ParticlesBackgroundSection3;
